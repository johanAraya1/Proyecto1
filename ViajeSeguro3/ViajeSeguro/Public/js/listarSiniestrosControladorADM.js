...
let mostrarSiniestros = async() => {
    ...
    for (let i = 0; i < listaSiniestros.length; i++) {
        ...
        btnModificar.addEventListener('click', () => {
            localStorage.setItem('siniestroId', listaSiniestros[i]['_id']);
            window.location.href = 'modificarSiniestros.html';
...
//         btnModificar.addEventListener('click', () => {
//             localStorage.setItem('siniestroId', listaSiniestros[i]['_id']);
//             window.location.href = 'modificarSiniestrosADM.html';
...
//     for (let i = 0; i < listaSiniestros.length; i++) {
//         let siniestro = listaSiniestros[i]['categoria'].toLowerCase();

//         if (siniestro.includes(filtro)) {
//             let fila = tbody.insertRow();
//             let siniestro = document.createElement('h3');
//             siniestro.innerText = listaSiniestros[i]['categoria'];
//             console.log(siniestro);
