...
let enviarDatos = () => {
    ...
    if (!errorEnFormulario) {
        ...
        let fechaDeVencimiento = new Date();
        fechaDeVencimiento.setFullYear(annoExp, mesExp, 1);
        let propietarioDeTarjeta = idPropietarioTarjeta;
        ...
        let estado = "Activa";
        let metodoDePago = formaDePago.value;



        registrarTarjetaCredito(metodoDePago, numeroTarjeta, entidadFinanciera, fechaDeVencimiento, codigoSeguridad, nombreEnTarjeta, propietarioDeTarjeta, estado);
